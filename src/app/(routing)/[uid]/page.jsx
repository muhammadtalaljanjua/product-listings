...
//         const productData = result.products.find((prod) => prod.uid === uid);
...
//   return (
//     <Box display="flex" justifyContent="center" sx={{ margin: "2rem" }}>
//       {loading ? (
...
//       ) : (
//         <Card
//           sx={{ display: "flex", alignItems: "center", boxShadow: 3, borderRadius: 3, padding: 3 }}
//         >
...
//                           backgroundColor:
//                             selectedVariation?.sku === variation.sku ? "#87BB40" : "#e0e0e0",
